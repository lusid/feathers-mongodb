...
class Service extends AdapterService {
  ...
  _find(params = {}) {
    ...
    const q = this._getModelFromParams(params).find(query);
    ...
    if (paginate && paginate.default) {
      return this._getModelFromParams(params)
  ...
  _create(data, params = {}) {
    ...
    const promise = Array.isArray(data)
      ? this._getModelFromParams(params).insertMany(data.map(setId))
      : this._getModelFromParams(params).insertOne(setId(data));
